...
func (h *HTTPMetricHandler) instrument(next HTTPHandlerFunc) HTTPHandlerFunc {
...
func handleGetInvoice(svc Aggregator) HTTPHandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) error {
		if r.Method != "GET" {
			return APIError{
...
func handleAggregate(svc Aggregator) HTTPHandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) error {
		if r.Method != "POST" {
			return APIError{
				Code: http.StatusBadRequest,
